"""Coordinator manifest builder used by autonomy consolidation."""
...
@dataclass
class CoordinatorManifestBuilder:
    """Reusable helper for generating coordinator manifests."""
    ...
    @staticmethod
    def expected_receipts(plan_id: str, step_id: str, agent_id: str) -> list[dict[str, str]]:
...
def build_manifest_payload(
    *,
    ...
    """Public helper mirroring legacy build_manifest function."""
