...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--force", action="append", choices=bootloader.SCAN_COMPONENTS, help="Force-run the specified component(s)")
    parser.add_argument("--skip", action="append", choices=bootloader.SCAN_COMPONENTS, help="Skip running the specified component(s)")
