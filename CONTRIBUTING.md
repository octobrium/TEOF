...
## How to contribute
1. Run `teof status` (add `--format json` if you need machine output) and `teof tasks --format json --summary` so coordination stays observable without dumping the entire backlog.
