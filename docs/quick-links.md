...
| `comm-mainline` | Communication Quickstart | Shows how to claim, broadcast, and monitor the coordination bus (manager-report) on day one. | [docs/onboarding/README.md#session--communication-loop](docs/onboarding/README.md#session--communication-loop) |
